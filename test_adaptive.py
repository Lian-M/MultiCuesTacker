...
X_r_past = np.load("5drones/X_r_past.npy")    # (B, N, 6, 3)
X_r_cur = np.load("5drones/X_r_cur.npy")    # (B, N, 3)
X_cb_past = np.load("5drones/X_cb_past.npy")    # (B, N, 6, 4)
X_cb_cur = np.load("5drones/X_cb_cur.npy")    # (B, N, 4)
A_cubes_cur = np.load("5drones/A_cubes_cur.npy")    # (B, N, N, N)
